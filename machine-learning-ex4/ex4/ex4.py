...
from feed_forward import deserialize_t
...
cost = ncf.nn_cost_function(nn_params, input_layer_size, hidden_layer_size, num_labels, X, y, lmd)
...
g = sg.sigmoid_gradient(np.array([-100, -0.5, 0, 0.5, 10]))
...
debug_cost = ncf.nn_cost_function(nn_params, input_layer_size, hidden_layer_size, num_labels, X, y, lmd)
...
res = opt.minimize(fun=ncf.nn_cost_function, x0=nn_params,
                   args=(input_layer_size, hidden_layer_size, num_labels, X, y, lmd),
                   method='TNC', jac=ncf.nn_grad_function, options={'maxiter': 400})

# Obtain theta1 and theta2 back from nn_params
print(res)
theta1, theta2 = deserialize_t(res.x, input_layer_size, hidden_layer_size, num_labels)
